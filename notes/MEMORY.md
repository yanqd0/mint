...
- [领域概念词汇表](DDD.md) — Issue/Project/Tag/Status（6 态 open/planned/dev/test/done/dropped）/Container（roadmap/plan 容器，3 态）/Issue Link（related/solves/duplicates）/Git 关联/capture/context/adapter 等核心概念与关系。
...
- [技术选型与决策](decisions.md) — ADR 式记录（D1-D18）：命名/ORM/CLI 框架/SQLite 集成/体积目标/状态机/close 语义/语言策略/tag/project 检测/容器建模/轻量迁移/issue links。
