...
mod dbg {
    ...
    fn dbg_search() {
        ...
        let mut i1 = Issue { id: 1, title: "Foo Bar".into(), body: None, kind: Kind::Problem, status: Status::Open, priority: 3, project_id: 1, project: Some("mint".into()), test_cmd: None, dropped_reason: None, last_commit_id: None, plan_id: None, machine_id: None, uid: None, hit_count: 0, labels: vec![], links: vec![], created_at: "1".into(), updated_at: "1".into() };
