...
1. **Record**: run `list` to check for duplicates → `add "<title>" --body "<description + source>"` (problem=problem, improvement=requirement, **chore/documentation/research/observation=task**).
