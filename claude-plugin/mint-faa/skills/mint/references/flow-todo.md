...
1. **Record**: run `list --json` to check for duplicates → `add "<title>" --body "<description + source>"` (problem=problem, improvement=requirement, **chore/documentation/research/observation=task**).
